/**
 * Brand Styling Constants for Admin Portal
 *
 ...
 * Do not modify without updating the landing page first.
 */
...
export const BRAND_COLORS = {
  ...
  // Admin-specific color (from landing page design)
...
// Use these with sx={{ p: SPACING.md }} or theme.spacing()
...
export const BUTTON_STYLES = {
  ...
  // Admin-specific button (orange gradient)
  admin: {
...
// These match Material-UI's default breakpoints
